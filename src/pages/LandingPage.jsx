                ...
                <div className="absolute top-0 w-[100%]"> {/*CONTENTS*/}
                    ...
                    <div className="h-[88vh]">
                        <div className="flex items-center flex-col justify-evenly h-[100%]">
                            ...
                            <div className="flex justfiy-center w-[82vw] text-center text-white font-Poppins text-[20px]">
                            ...
                            <div className="flex justfiy-center text-center text-white font-Poppins text-[20px] font-bold">
