            ...
            <div className="h-[95%] w-[95%] border-[1px] bg-white rounded-[10px] shadow-[0_4px_4px_rgba(0,0,0,0.10)] flex flex-col">
              <div className="w-[100%] h-[10%] flex">
                ...
                <div className="w-[40%] h-[100%] flex items-end justify-evenly">
                  ...
                  >
                    <DropdownItem onClick={() => handleSortByProgram('ALL COURSES')}>ALL COURSES</DropdownItem>
                    {programs.map((prog) => (
                      <DropdownItem key={prog._id} onClick={() => handleSortByProgram(prog.name)}>{prog.name}</DropdownItem>
                    ))}
                  </Dropdown>
                  <Button style={{ backgroundColor: "#1F3463", height: "30px" }} onClick={handleOpenModalForAdd}>
                    Add Student
                  </Button>
                </div>
              </div>
