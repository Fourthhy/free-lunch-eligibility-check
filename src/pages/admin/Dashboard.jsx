                            ...
                            <div className="row-span-7 h-[100%]">
                                <div className="h-[50%] flex flex-col gap-3 justify-evenly ml-[20px]">
                                    ...
                                    <div className="h-[8vh] flex w-[100%]">
                                        <div className={`${selectedItem == 0 ? itemHighlightBorder : ``} h-[100%] w-[100%]`} onClick={() => { handleSelectItem(0) }}>
                                    ...
                                    {/* MASTERLIST SECTION */}
                                    <div className="h-[8vh] flex w-[100%]">
                                        <div className={`${selectedItem == 1 ? itemHighlightBorder : ``} h-[100%] w-[100%]`} onClick={() => { handleSelectItem(1) }}>
                                    ...
                                    {/* SCHEDULE SECTION */}
                                    <div className="h-[8vh] flex w-[100%]">
                                        <div className={`${selectedItem == 2 ? itemHighlightBorder : ``} h-[100%] w-[100%]`} onClick={() => { handleSelectItem(2) }}>
                                            <div className="ml-[10px] flex items-center h-[100%]">
                                    ...
                                    <div className="h-[8vh] flex w-[100%]">
                                        <div className={`${selectedItem == 3 ? itemHighlightBorder : ``} h-[100%] w-[100%]`} onClick={() => { handleSelectItem(3) }}>
                                            <div className="ml-[10px] flex items-center h-[100%]">
                                                <svg width="3vw" height="4vh" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M23.3334 3.08325H10C9.11597 3.08325 8.26812 3.4081 7.643 3.98634C7.01788 4.56458 6.66669 5.34883 6.66669 6.16659V30.8333C6.66669 31.651 7.01788 32.4353 7.643 33.0135C8.26812 33.5917 9.11597 33.9166 10 33.9166H30C30.8841 33.9166 31.7319 33.5917 32.357 33.0135C32.9822 32.4353 33.3334 31.651 33.3334 30.8333V12.3333L23.3334 3.08325Z" stroke={`${selectedItem === 3 ? `#1F3463` : `#FFFFFF`}`} stroke-width="4" stroke-linecap="round" stroke-linejoin="round" fill={selectedItem == 3 ? `#FFFFFF` : ``} />
                                                    <path d="M23.3333 3.08325V12.3333H33.3333" stroke={`${selectedItem === 3 ? `#1F3463` : `#FFFFFF`}`} stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M26.6666 20.0417H13.3333" stroke={`${selectedItem === 3 ? `#1F3463` : `#FFFFFF`}`} stroke-width="3" stroke-linecap="square" stroke-linejoin="round" />
                                                    <path d="M26.6666 26.2083H13.3333" stroke={`${selectedItem === 3 ? `#1F3463` : `#FFFFFF`}`} stroke-width="3" stroke-linecap="square" stroke-linejoin="round" />
                                                    <path d="M16.6666 13.875H15H13.3333" stroke={`${selectedItem === 3 ? `#1F3463` : `#FFFFFF`}`} stroke-width="3" stroke-linecap="square" stroke-linejoin="round" />
                                                </svg>
