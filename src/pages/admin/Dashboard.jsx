                        ...
                        <div className="grid grid-cols-1 grid-rows-9 h-screen">
                            ...
                            <div className="row-span-7 h-[100%] w-[100%]">
                                <div className="h-[50%] flex flex-col gap-1 justify-evenly ml-[20px]">
                                    ...
                                    <div className="h-[8vh] flex w-[100%]">
                                        <div className={`${selectedItem == 2 ? itemHighlightBorder : ``} h-[100%]`} onClick={() => { handleSelectItem(2) }}>
                                            <div className="ml-[10px] flex items-center h-[100%]">
                                    ...
                                    <div className="h-[8vh] flex w-[100%]">
                                        <div className={`${selectedItem == 3 ? itemHighlightBorder : ``} h-[100%]`} onClick={() => { handleSelectItem(3) }}>
                                            <div className="ml-[10px] flex items-center h-[100%]">
